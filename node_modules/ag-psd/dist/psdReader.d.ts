...
export declare function getCompositeImageData(psd: Psd): PixelData | undefined;
export declare function getCompositeCanvas(psd: Psd): HTMLCanvasElement | undefined;
export declare function getLayerImageData(layer: Layer): PixelData | undefined;
export declare function getLayerMaskImageData(layer: Layer): PixelData | undefined;
export declare function getLayerRealMaskImageData(layer: Layer): PixelData | undefined;
export declare function getLayerCanvas(layer: Layer): HTMLCanvasElement | undefined;
export declare function getLayerMaskCanvas(layer: Layer): HTMLCanvasElement | undefined;
export declare function getLayerRealMaskCanvas(layer: Layer): HTMLCanvasElement | undefined;
