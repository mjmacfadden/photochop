"use strict";
(self["webpackChunkvantage_point"] = self["webpackChunkvantage_point"] || []).push([["tiff-export"],{
  ...
  toArrayBuffer: function (canvas, callback, options) {
    ...
    try {
      var w = canvas.width,
        ...
        offset = 0,
        iOffset = 258,
        // todo calc based on offset field length, add to final offset when compiled
        //iOffsetPtr,
        entries = 0,
        offsetList = [],
        idfOffset,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CanvasToTIFF);

/***/ }

}]);
//# sourceMappingURL=tiff-export.bundle.js.map